...
def build_sequence_index(base_path: str) -> Dict[str, Dict[str, str]]:
    ...
    Only sequence dirs holding BOTH metadata.csv and mosaic.png are indexed.
    """
    ...
    for item in os.listdir(base_path):
        ...
        if not (os.path.isdir(seq_dir) and os.path.isfile(metadata_path)
                and os.path.isfile(mosaic_path)):
            continue
