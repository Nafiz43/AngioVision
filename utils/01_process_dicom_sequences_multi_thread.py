...
if __name__ == "__main__":
    ...
    parser.add_argument("--input_root", type=Path, default=Path("/data/Deep_Angiography/DICOM"))
    parser.add_argument("--output_root", type=Path, default=Path("/data/Deep_Angiography/DICOM_Sequence_Processed"))
