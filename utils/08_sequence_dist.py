...
# PATHS
# =========================================================
INPUT_CSV = "/data/Deep_Angiography/DICOM-metadata-stats/consolidated_metadata_ALL_Sequences.csv"
OUTPUT_DIR = "/data/Deep_Angiography/DICOM-metadata-stats"

HIST_PNG = os.path.join(OUTPUT_DIR, "number_of_instances_histogram.png")
BOX_PNG = os.path.join(OUTPUT_DIR, "number_of_instances_boxplot.png")
QQ_PNG = os.path.join(OUTPUT_DIR, "number_of_instances_qqplot.png")
STATS_TXT = os.path.join(OUTPUT_DIR, "number_of_instances_basic_stats.txt")
...
COLUMN_NAME = "Number of Instances"
...
if len(values) == 0:
    raise ValueError(f"No valid numeric values found in '{COLUMN_NAME}'.")
...
plt.title("Distribution of Number of Instances per Sequence")
...
plt.title("Boxplot of Number of Instances")
plt.xlabel("Number of Instances")
plt.tight_layout()
...
plt.title("Q-Q Plot of Number of Instances")
plt.tight_layout()
