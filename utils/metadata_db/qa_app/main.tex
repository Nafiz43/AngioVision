...
the architecture is modality-agnostic.
...
The stack comprises Python, Flask, a vanilla-JavaScript frontend, pydicom, NumPy, Pillow, ChromaDB, the HuggingFace
...
AngioVision is data infrastructure, not a predictive model;
...
descriptive analyses are completed entirely within the interface. The transition
...
of 3D/MPR rendering is the principal trade-off; pairing with OHIF
...
the image encoder is user-selectable, alternative encoders can be substituted
